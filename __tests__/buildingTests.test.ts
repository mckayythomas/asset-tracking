...
describe("buildingResolver testing", () => {
  ...
  it("Creates a new building using createBuilding resolver", async () => {
    ...
    const result: any = await buildingResolvers.Mutation.createBuilding(
      null,
      params,
      context
    );
  ...
  it("Updates an existing building using updateBuilding resolver", async () => {
    ...
    const result: any = await buildingResolvers.Mutation.updateBuilding(
      null,
      params,
      context
    );
  ...
  it("Deletes a building using deleteBuilding resolver", async () => {
    ...
    const result: any = await buildingResolvers.Mutation.deleteBuilding(
      null,
      params,
      context
    );
